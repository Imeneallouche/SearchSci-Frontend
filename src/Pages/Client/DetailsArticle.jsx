  ...
  return (
    <div className="min-h-screen relative ">
      ...
      <div className="  relative">
        <a href={detailsArticle && detailsArticle.urlPdf} className="text-blue-500 absolute md:top-60 md:right-30 text-center  ">
          [VIEW PDF]
        </a>
      </div>
      ...
      <span
  onClick={(e) => {
    const url = 'http://127.0.0.1:8000/api/addToFavorites' + detailsArticle.id;
  ...
  {isFavorite ? (
    ...
    >
      ...
      <p className="mb-6 mt-6">
          ...
          <p className="mb-6 mt-6">
            <strong>Mots cle:</strong> {detailsArticle && detailsArticle.motsCles}
          ...
          <p className="mb-6 mt-6">
            <strong>Texte integral:</strong>  {detailsArticle && detailsArticle.texteIntegral}
          </p>
